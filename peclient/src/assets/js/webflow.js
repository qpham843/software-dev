...
function(t, e, n) {
    ...
    r.define("forms", t.exports = function(t, e) {
        ...
        function y(e, n) {
                ...
                ! function(e, n) {
                    ...
                    if (g) l.on("click", function(t) {
                        ...
                        v.on("click", function() {
                            ...
                            (i = r.target && r.target.files && r.target.files[0]) && (o.toggle(!1), c.toggle(!1), a.toggle(!0), m.text(i.name), z() || _(n), n.fileUploads[e].uploading = !0, function(e, n) {
                                var i = {
                                    name: e.name,
                                    size: e.size
                                };
                    ...
                    function E(t) {
                        var i = t.responseJSON && t.responseJSON.msg,
                            r = y;
                        "string" == typeof i && 0 === i.indexOf("InvalidFileTypeError") ? r = b : "string" == typeof i && 0 === i.indexOf("MaxFileSizeError") && (r = w), h.text(r), l.removeAttr("data-value"), l.val(""), a.toggle(!1), o.toggle(!0), c.toggle(!0), n.fileUploads[e].uploading = !1, z() || x(n)
                    }
            ...
            r.handler = null, r.redirect = i.attr("data-redirect"), w.test(s) ? r.handler = O : s || (o ? r.handler = E : b())
        }
...
function(t, e, n) {
    ...
    i.define("navbar", t.exports = function(t, e) {
        ...
        function _(n, r) {
            ...
            }(u), u.el.off(p), u.button.off(p), u.menu.off(p), O(u), a ? (E(u), u.el.on("setting" + p, function(t) {
                return function(n, i) {
                    i = i || {};
                    var r = l.width();
                    O(t), !0 === i.open && A(t, !0), !1 === i.open && $(t, !0), t.open && e.defer(function() {
                        r !== l.width() && S(t)
                    })
                }
            }(u))) : (! function(e) {
        ...
        u.ready = u.design = u.preview = function() {
            ...
            o.each(_), y(), i.resize.on(x)
        }, u.destroy = function() {
            b = t(), y(), o && o.length && o.each(k)
        };
        ...
        function A(t, e) {
            if (!t.open) {
                ...
                var r = M(t),
                    ...
                    u = t.el.height(),
                    l = t.el[0];
                if (T(0, l), w.intro(0, l), i.redraw.up(), a || f.on("tap" + p, t.outside), !e) {
