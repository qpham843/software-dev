...
import com.example.demo.service.UpdateJobService;
...
public class UpdateJobController {
	private static org.slf4j.Logger logger = LoggerFactory.getLogger(UpdateJobController.class);
	@Autowired StatusRepository statusRepository;
	@Autowired AuthService authService;
	@Autowired UpdateJobService updateJobService;
	...
	public ResponseEntity getAllStatuses(
		...
		return new ResponseEntity<List<UpdateJobEntity>>(updateJobService.findRecent(), HttpStatus.OK);
 	}
}
